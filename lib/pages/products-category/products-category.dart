...
class _ProductsCategoriesState extends State<ProductsCategories> {
        ...
        : isListView
            ? Column(
                children: [
                  ...
                  Visibility(
                    visible: SubCategories.length == 0 ||
                            widget.name.toString() == "قسم الأولاد و البنات"
                        ? false
                        : true,
                    child: Padding(
                        padding:
                                      ...
                                      if (index == 0) {
                                        ...
                                        setState(() {
                                          if (selectedIndexes.contains(index)) {
                                            ...
                                            print("2");
                                            print(Sub_Category_Key[0]);
                                            if (Sub_Category_Key[0]
                                                        .toString() ==
                                                    "Women Clothing" ||
                                                Sub_Category_Key[0]
                                                        .toString() ==
                                      ...
                                      onTap: () {
                                        setState(() {
                                          if (selectedCategoryKeys.length > 1) {
                                            int removeIndex = Sub_Category_Key
                                                .indexWhere((key) =>
                                                    key ==
  ...
  String getCategoryKey() {
    String key = widget.category_id == "Women Shoes" ||
            widget.category_id == "Men Shoes"
        ? "Shoes"
        : widget.category_id == "Underwear & Sleepwear, Underwear Sleepwear"
            ? "Underwear %26 Sleepwear , Underwear  Sleepwear"
            : widget.category_id ==
                    "Home & Living, Home Living, Home Textile,Tools & Home Improvement"
                ? "Home %26 Living, Home Living, Home Textile,Tools %26 Home Improvement"
                : widget.category_id == "Sports %26 Outdoor, Sports  Outdoor"
                    ? "Sports %26 Outdoor, Sports  Outdoor"
                    : widget.category_id == "Women Apparel Baby"
                        ? "Women Apparel"
                        : widget.category_id ==
