...
class SwitchPolicy extends StatefulWidget {
  const SwitchPolicy({Key? key}) : super(key: key);

  @override
  State<SwitchPolicy> createState() => _SwitchPolicyState();
}

class _SwitchPolicyState extends State<SwitchPolicy> {
  @override
